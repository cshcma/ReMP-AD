...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, out_layers, normalize: bool = False,weighted: bool = False,mask_info=None):
        features = self.visual(image, out_layers, weighted=weighted,mask_info=mask_info)
